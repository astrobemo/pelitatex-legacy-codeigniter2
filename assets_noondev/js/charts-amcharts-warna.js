var ChartsAmcharts = function() {
    ...
    var initChart1 = function() {
        ...
        var warna_id = $('#warna_id_data').html();
        var tahun = $('#tahun_data').html();
        var url = "master/get_penjualan_by_warna_barang?warna_id="+warna_id+"&tahun="+tahun+"&tipe=0";
        var data_st  ={};
        var chartData = [];
        var j = 0;
    ...
    var initChart2 = function() {
        ...
        var warna_id = $('#warna_id_data').html();
        var tahun = $('#tahun_data').html();
        var url = "master/get_penjualan_by_warna_barang?warna_id="+warna_id+"&tahun="+tahun+"&tipe=1";
        var data_st  ={};
        var chartData = [];
        var j = 0;
        var penjualan_other = 0;
