...
foreach ($stok_barang as $row) {
	$stok_brg[$row->barang_id] = 0
	$stok_brg_roll[$row->barang_id] = 0
	foreach ($this->gudang_list_aktif as $row2) {
		$stok_brg[$row->warna_id] += ${"gudang_".$row2->id."_qty"};
		$stok_brg_roll[$row->warna_id] += ${"gudang_".$row2->id."_roll"};
	};
}
