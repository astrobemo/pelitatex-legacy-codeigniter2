					...
					<div class="portlet-body">
								...
								<tbody>
									...
									foreach ($penjualan_detail as $row) { ?>
										<tr id='id_<?=$row->id;?>'>
											...
											<td>
												<span class='nama_jual'><?=$row->nama_barang;?></span> 
												<?$barang_id=$row->barang_id;?>
											</td>
											<td>
												<span class='kode_beli'><?=$row->kode_beli;?></span> 
											</td>
											<td>
												<span class='nama_jual_tercetak' style="<?=($row->nama_barang !== $row->nama_jual_tercetak ? 'background:yellow' : '');?>"><?=$row->nama_jual_tercetak;?></span> <?=$row->nama_warna;?>
											</td>
											<td>
												<?=$row->nama_warna;?>
											</td>
						...
						<div>
							<?if ($status_aktif != -1) {
								...
								<button style="<?=($status != 1 ? $display : '');?>" type='button'<?if ($idx == 1) { echo 'disabled'; }?> <?=$disabled;?> class='btn btn-lg red hidden-print btn-close' id='btn-lock-transaction'><i class='fa fa-lock'></i> LOCK </button>
								...
								<!-- ======================================================================================================== -->
								<button style='<?=$display;?>'  type="button" tabindex='-1' class="btn btn-lg blue" onclick="printInvoice('0')"><i class='fa fa-print'></i> FAKTUR</button>
								<button style='<?=$display;?>'  type="button" tabindex='-1' class="btn btn-lg blue" onclick="printInvoicePL('0')"><i class='fa fa-print'></i> FAKTUR + DETAIL</button>
								
								<a id="btn-invoice-sj" style='<?=$display;?>'  tabindex='-1' class='btn btn-lg yellow-gold hidden-print' onclick="setPrintInvoiceSJ('0')" href='#portlet-config-address' data-toggle="modal">
									<i class='fa fa-print'></i> FAKTUR + SJ
								</a>
								<!-- ======================================================================================================== -->
								<?if ($is_custom_view) { ?>
									<hr>
									<button style='<?=$display;?>'  type="button" tabindex='-1' class="btn btn-lg purple" onclick="printInvoice('1')"><i class='fa fa-print'></i> FAKTUR</button>
									<button style='<?=$display;?>'  type="button" tabindex='-1' class="btn btn-lg purple" onclick="printInvoicePL('1')"><i class='fa fa-print'></i> FAKTUR + DETAIL</button>
									
									<a id="btn-invoice-sj" style='<?=$display;?>'  tabindex='-1' class='btn btn-lg purple hidden-print' onclick="setPrintInvoiceSJ('1')" href='#portlet-config-address' data-toggle="modal">
										<i class='fa fa-print'></i> FAKTUR + SJ
									</a>
								<?}?>
							...
							<?/* if (is_posisi_id()==1) {?>
								<button type="button" class='btn btn-lg purple hidden-print ' onclick="testPrintHTML()"><i class='fa fa-print'></i> TESTING </button>
...
<?//include_once "penjualan_detail_webprint.php";?>
