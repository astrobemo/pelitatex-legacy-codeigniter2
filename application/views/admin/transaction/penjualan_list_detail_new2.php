					...
					<div class="portlet-body">
							...
							<tbody>
								...
								foreach ($penjualan_detail as $row) { ?>
									<tr id='id_<?=$row->id;?>'>
										...
										<?/* if (is_posisi_id() == 1) {
											$harga_nppn = number_format($row->harga_jual/1.11,'2','.','');?>
											<td>
						...
						<div>
							<?if ($status_aktif != -1) {
								...
								<!-- untuk tombol html -->
								<!-- <button style='<?=$display;?>'  tabindex='-1' class='btn btn-lg yellow-gold hidden-print' onclick="printInvoiceSJ()">
								...
								<a id="btn-sj" style='<?=$display;?>' href='#portlet-config-address' data-toggle="modal" tabindex='-1' class="btn btn-lg green" >SURAT JALAN</a>
								<a style='<?=$display;?>' href='#portlet-config-address-non' data-toggle="modal" tabindex='-1' class="btn btn-lg green" >SJ NO HARGA</a>
