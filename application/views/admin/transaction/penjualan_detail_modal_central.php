							...
							<div class="form-group customer_section">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-6">
									...
									<select name="customer_id_central" class="form-control" id='customer_id_select' onchange="cekCustomerLimitCentral()">
			                				<option value=''>Pilih</option>
											<?foreach ($customer_central as $row) {?>
					...
					<div class="modal-body">
						<form action="<?=base_url('transaction/penjualan_list_update')?>" class="form-horizontal" id="form_edit_data" method="post">
							...
							<div class="form-group">
			                    ...
			                    <div class="col-md-6">
	                    			<select disable name="po_penjualan_id" class="form-control" id="po_penjualan_edit_select">
										<option value="Non PO"  <?=($po_penjualan_id == "" && $po_number == "" ? "selected" : "");?>>Non PO</option>
										<option value="manual" <?=($po_penjualan_id == "" && $po_number != "" ? "selected" : "");?> >SAMPLE/NOTA</option>
										<?foreach ($po_penjualan_list as $row) {?>
											<option  <?=($po_penjualan_id == $row->id ? "selected" : "");?> value="<?=$row->id?>"><?=$row->po_number;?></option>
										<?}?>
									</select>
									<input style="<?=($po_penjualan_id == "" && $po_number != "" ? "" : "display:none");?>" id="inputPOEdit" name='po_number' maxlength='30' value="<?=$po_number;?>" class='form-control' placeholder="">
			                    </div>
			                </div> 
			                    	...
			                    	<div id='edit-select-customer'  <?if ($penjualan_type_id == 3) { ?> hidden <?}?> >
			                    		...
			                    		<div id='jatuh-tempo-warning-edit' hidden>
				                    		...
				                    		<div style="width:100%; position:relative">
					                    		...
					                    		<div id="jatuh-tempo-list-edit-jual">
							            			<table>
							            				<thead>
							                				<tr>
							                					<th>Invoice</th>
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-6">
	                    			...
	                    			<select name="gudang_id" class='form-control' id='gudang_id_select'>
		                				<?$gudang_default = "";foreach ($this->gudang_list_aktif as $row) {
					...
					<form action="<?= base_url('transaction/jual_kirim_insert'); ?>" class="form-horizontal" id="form_cetak_sj_non" method="post">
						<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<!-- <button type="button" id='cetak-invoice-sj' class="btn blue btn-active btn-trigger btn-invoice-cetak pull-right" data-dismiss="modal">Cetak SJ </button>
									<button type="button" id='cetak-invoice-sj-no-harga' class="btn blue btn-active btn-trigger btn-invoice-cetak pull-right" data-dismiss="modal">Cetak SJ NON HARGA </button> -->
									<button type="button" class="btn blue btn-active btn-trigger btn-invoice-cetak pull-right" data-dismiss="modal" >Cetak SJ </button>
									<button type="button" class="btn blue btn-active btn-trigger btn-invoice-cetak pull-right" data-dismiss="modal">Cetak SJ NON HARGA </button>
									<button type="button" class="btn default btn-active pull-right" data-dismiss="modal">Close</button>
								</div>
						</div>
					</form>
