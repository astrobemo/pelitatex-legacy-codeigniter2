						...
						<form action="<?=base_url('transaction/penjualan_list_insert')?>" class="form-horizontal" id="form_add_data" method="post">
							...
							<div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-8">
			                    	<select class='form-control input1' name='penjualan_type_id' id="penjualan-type-select">
			                ...
			                <div class="form-group add-alamat-keterangan">
			                    ...
			                    <div class="col-md-8">
			                    	<input name='alamat_keterangan' class='form-control' id="add-alamat-keterangan">
			                    </div>
			                </div>
						...
						<form action="<?=base_url('transaction/penjualan_list_update')?>" class="form-horizontal" id="form_edit_data" method="post">
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-md-8">
									<div class="checkbox-list">
				                    	<label>
				                    	<input type='checkbox' <?=($fp_status == 1 ? 'checked' : '');?> name='fp_status' id='fp_status_edit' value='1'>Ya</label>
				                    </div>
			                    </div>
			                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    * </span>
		                    ...
		                    <div class="col-md-9" style="position:relative">
		                    	<div class="checkbox-list">
									<label>
									<input type="checkbox" class="checkbox-print" data-print="1" name="print_target" value="1"><span class='ket-print'> Faktur </span></label>
									<label>
									<input type="checkbox" class="checkbox-print" data-print="2" name="print_target" value="2"><span class='ket-print'> Detail </span></label>
									<label>
									<input type="checkbox" class="checkbox-print" data-print="3" name="print_target" value="3" <?=($print_now ? "checked" : '');?> ><span class="ket-print  <?=($print_now ? 'selected-print-blue' : '');?> "> Faktur + Detail </span></label>
									<label>
									<input type="checkbox" class="checkbox-print" data-print="4" name="print_target" value="4" <?//=($print_now && $npwp != '' ? "checked" : '');?> ><span class="ket-print  <?//=($print_now && $npwp != '' ? 'selected-print-green' : '');?> "> Surat Jalan </span></label>
										<div style="padding-left:20px" id="daftar-alamat-sj" hidden >
											<b>Daftar Alamat</b>
											<?if ($customer_id != '' && $customer_id != 0) {?>
												<div class='alamat-list'>
													<label>
													<input type="radio" class="checkbox-alamat" data-alamat="0" name="print_alamat" ><span class="ket-alamat"> <?=$alamat_keterangan?></span></label>
												</div>
											<?}?>
											<?foreach ($customer_alamat_kirim as $row) {?>
												<div class='alamat-list'>
													<label>
													<input type="radio" class="checkbox-alamat" data-alamat="<?=$row->id;?>" name="print_alamat" ><span class="ket-alamat"> <?=(trim($row->alamat) == "" ? '- ': $row->alamat) ?></span></label>
												</div>
											<?}?>
										</div>
									<label>
									<input type="checkbox" class="checkbox-print" data-print="5" name="print_target" value="5"><span class='ket-print'> Surat Jalan No Harga </span></label>
										<div style="padding-left:20px" id="daftar-alamat-sj-2" hidden >
											<b>Daftar Alamat</b>
											<?if ($customer_id != '' && $customer_id != 0) {?>
												<div class='alamat-list'>
													<label>
											...
											<?foreach ($customer_alamat_kirim as $row) {?>
												<div class='alamat-list'>
													<label>
													<input type="radio" class="checkbox-alamat" data-alamat="<?=$row->id;?>" name="print_alamat_2" ><span class="ket-alamat"><?=(trim($row->alamat) == "" ? '- ': $row->alamat) ?></span></label>
												</div>
											<?}?>
										</div>
								</div>
						...
						<hr/>
							<p class='btn-detail-toggle' style='cursor:pointer; position:relative'>
								...
								<?if (is_posisi_id() == 5 || is_posisi_id() == 1) {?>
									<a target="_blank" style='position:absolute; right : 10px; top:-10px' href="<?=base_url().is_setting_link('inventory/stok_barang_ajax');?>" class="btn btn-lg green"><i class='fa fa-search'></i>STOK BARANG</a>
								<?}?>
							</p>
...
jQuery(document).ready(function() {
	...
	$(".checkbox-print").change(function(){
		$.uniform.update($(this));
		let ini = $(this).closest('label').find('.ket-print');
		let value = $(this).attr('data-print');
		if($(this).is(':checked')){
			if (value <=3 ) {
				ini.addClass('selected-print-blue');
			}else{
				ini.addClass('selected-print-green');
			};

			if (value == 4) {
				$("#daftar-alamat-sj").show();
			};
			if (value == 5) {
				$("#daftar-alamat-sj-2").show();
			};
		}else{
			if (value <=3 ) {
				ini.removeClass('selected-print-blue');
			}else{
				ini.removeClass('selected-print-green');
			};

			if (value == 4) {
				$("#daftar-alamat-sj").hide();
			};
			if (value == 5) {
				$("#daftar-alamat-sj-2").hide();
			};
		...
		<?if($penjualan_id != '' && $status==0){?>
		    ...
		    $('.btn-faktur-print').click(function(){
		    	reset_print();
				$('[data-print=1]').prop("checked",true);
				$(".checkbox-print").change();
			});

			$('.btn-print-detail').click(function(){
		    	reset_print();
				$('[data-print=2]').prop("checked",true);
				$(".checkbox-print").change();
				// print_detail();
			});
			...
			$('.btn-print-kombi').click(function(){
		    	reset_print();
				$('[data-print=3]').prop("checked",true);
				$(".checkbox-print").change();
				// print_detail();
			});
			...
			$('.btn-surat-jalan').click(function(){
		    	reset_print();
				$('[data-print=4]').prop("checked",true);
				$(".checkbox-print").change();
				// print_detail();
			});
			...
			$('.btn-surat-jalan-noharga').click(function(){
		    	reset_print();
				$('[data-print=5]').prop("checked",true);
				$(".checkbox-print").change();
				// print_detail();
			});

			$('.print-testing').click(function(){
				$('[data-print=99]').prop("checked",true);
				// print_detail();
			});
		    ...
		    $('.btn-print-action').click(function(){
				...
				$(".checkbox-print").each(function(){
					let ini = $(this);
					// console.log(ini);
					if (ini.is(":checked")) {
						let action = ini.attr("data-print");
						if(action == 4){
							let alamat_get = $("[name=print_alamat]:checked").attr('data-alamat');
							// alert(alamat_get);
							if (alamat_get != '' && typeof alamat_get !== 'undefined' ) {
								action_print.push(action);
							}else{
								status = 0;
				...
				// alert(action_print);
				if (status == 1) {
					$.each(action_print, function(i,action){
						// alert(action);
						if (action == 1 ) {
...
//========================================================================================
	...
	//====================================btn save=============================    
	    ...
	    $('.btn-save-tab').click(function(){
	    	...
	    	let nama =	$('#form_add_data [name=nama_keterangan]').val();
	    	if ($('#form_add_data [name=tanggal]').val() != '') {
	    		if (penjualan_type_id == 1 || penjualan_type_id == 2 ) {
	    			if($('#form_add_data [name=customer_id]').val() != ''){
	    				$('#form_add_data').submit();
