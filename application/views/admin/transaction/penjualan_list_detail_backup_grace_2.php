					...
					<div class="portlet-body">
						...
						<div>
							<?if ($status_aktif != -1) {
								...
								<button   type="button" tabindex='-1' class="btn btn-lg blue" onclick="printInvoice()">FAKTUR</button>
								<button   type="button" tabindex='-1' class="btn btn-lg blue" onclick="printInvoiceDetail()">FAKTUR + DETAIL</button>
								<a href='#portlet-config-address' data-toggle="modal" tabindex='-1' class="btn btn-lg green" >SURAT JALAN</a>
								<a href='#portlet-config-address-non' data-toggle="modal" tabindex='-1' class="btn btn-lg green" >SJ NO HARGA</a>
      ...
      <div class="modal-dialog">
            <form action="<?= base_url('transaction/jual_kirim_insert'); ?>" class="form-horizontal" id="form_cetak_sj" method="post">
                  <div class="modal-content">
                        ...
                        <div class="modal-footer">
                              <button type="button" class="btn blue btn-active btn-trigger btn-cetak pull-right" data-dismiss="modal">Cetak</button>
	...
	//====================================penjualan type=============================
	    ...
	    $('.pin_special_edit').keyup(function (e) {
	    	if($(this).val().length > 5){
				...
				if(cek_pin($("#form_edit_data"),'.pin_special')){
