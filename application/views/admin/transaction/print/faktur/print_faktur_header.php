<?
	...
	$pdf->Text( 70, 14.5, "NO  ");
	$pdf->Text( 75, 14.5, ":");
	$pdf->Text( 76, 14.5, $no_faktur_lengkap);
	$pdf->Text( 122, 14.5, "KEPADA : ".$nama_customer);
	...
	$pdf->Text( 70, 17.9, $sj_pre[0]);
	if ($sj_pre[0] != '') {
		$pdf->Text( 75, 17.9, ":");
	}
	$pdf->Text( 76, 17.9, $sj_baris[0]);
	//baris 3
	...
	$pdf->Text( 76, 21.5, $sj_pre[1]);
	$pdf->Text( 82, 21.5, $sj_baris[1]);
