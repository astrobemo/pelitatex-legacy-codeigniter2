<?
    ...
    $packing_list_start = "<table width='100%' style='font-size:2.5mm; border-collapse: collapse; border-bottom:1px solid black;' cellspacing='0'>";
    $packing_list_title = "
    <tr>
    ...
    $packing_list_body = [];
    $hght = '2mm';
    $st = "height:$hght; padding:0mm;overflow:hidden;";
            ...
            foreach ($vl['packing_list'] as $k2 => $vl2) {
                ...
                if ($k2 == 0) {
                    ...
                    $packing_list_body[$pgdtl] .= "<tr>
                        <td 
                        style='".($nama_print != '' ? $bT : '')." height: $hght; font-size:2.5mm;'>".
                        ...
                        <td style='".($nama_print != '' ? $bT : $bdT)." $bR $st text-align:right; padding-right:2.5mm'>".strtoupper($vl['total_qty'])."</td>
                        $vl2</tr>";
                }else{
