<?
    ...
    $packing_list_start = "<table width='100%' style='font-size:3mm; border-collapse: collapse; border-bottom:1px solid black;' cellspacing='0'>";
    $packing_list_title = "
    <tr>
        ...
        foreach ($nama_warna as $key => $value) {
            ...
            for ($aa=0; $aa < $q_row ; $aa++) {
                ...
                for ($z=0; $z < 10 ; $z++) {
                    ...
                    $row_render .=  "<td style='$st width:10.5mm; font-size:2.5mm; text-align:right; ".($aa==0 ? ($key == 0 ? $bT : $bdT) : "")." '>
                        ".(isset($q_array[$i_arr]) ? str_replace('.00', '', $q_array[$i_arr]) : '')."
                    </td>";
                }
            ...
            foreach ($vl['packing_list'] as $k2 => $vl2) {
                ...
                if ($k2 == 0) {
                    ...
                    $packing_list_body[$pgdtl] .= "<tr>
                        <td 
                        style='".($nama_print != '' ? $bT : '')." height: 3mm; font-size:2.5mm;'>".
                        strtoupper($nama_print).
                        "</td>
                        <td style='".($nama_print != '' ? $bT : $bdT)." $st font-size:2.5mm; '>".strtoupper($vl['nama_warna'])."</td>
                        <td style='".($nama_print != '' ? $bT : $bdT)." $st text-align:center;  font-size:2.5mm;'>".strtoupper($vl['nama_satuan'])."</td>
                        <td style='".($nama_print != '' ? $bT : $bdT)." $st text-align:center; font-size:2.5mm;'>".strtoupper($vl['total_roll'])."</td>
                        <td style='".($nama_print != '' ? $bT : $bdT)." $bR $st text-align:right; font-size:2.5mm; padding-right:2.5mm'>".strtoupper($vl['total_qty'])."</td>
                        $vl2</tr>";
                }else{
