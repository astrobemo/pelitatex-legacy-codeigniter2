<?
	$table_header_jual = "<table width='100%' style='border-collapse: collapse;' cellspacing='0'>
		...
		<tr>
			<td style='border-top:1px solid #ccc; border-bottom:1px solid #ccc;padding:0mm; height:3mm;font-size:3mm;  '>".($po_number != '' ? 'PO/Ket : '.$po_number : '')."</td>
			<td style='text-align:right; border-top:1px solid #ccc; border-bottom:1px solid #ccc;padding:0mm; font-size:3mm;  '>INVOICE NO : ".$no_faktur_lengkap."</td>
		</tr>
	</table>";
