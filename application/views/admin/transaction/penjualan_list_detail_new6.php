...
<div class="page-content">
	<div class='container'>
		...
		<?include_once 'penjualan_detail_modal_new.php';?>
				...
				<div class="portlet light">
					...
					<div class="portlet-body">
						...
						<?if ($po_penjualan_id != '' && count($po_penjualan_barang) > 0 ) {?>
							<div>
								<div style="font-size:1.2em">
									<b>PO :</b> 
									<b><a href="<?=base_url().is_setting_link('transaction/po_penjualan_detail').'?id='.$po_penjualan_id;?>" target="_blank"><?=$po_number?></a></b>
									<span class="label label-info" style="cursor:pointer" onclick="togglePOInfo()">show/hide<i class="fa fa-caret-down"></i></span>
									<ul id="data-PO">
										<li style="list-style-type:none">
											<div style="display:inline-block; width:140px"><b> Daftar Barang</b></div> 
											<div style="display:inline-block; width:70px"><b>Sisa PO</b></div> 
											<div style="display:inline-block; width:150px"><b>Keterangan</b></div> 
										</li>
										<?foreach ($po_penjualan_barang as $row) {?>
											<li>
												<div style="display:inline-block; width:140px"><?=$row->nama_barang;?> <?=$row->nama_warna;?></div> 
												<div style="display:inline-block; width:70px"><?=number_format(($row->qty-$row->qty_invoice),'0','.','.');?></div> 
												<div style="display:inline-block; width:150px"><?=($row->keterangan)?></div> 
											</li>
										<?}?>
									</ul>
								</div>
						...
						<div>
                            ...
                            <?} */?>
							<?if ($po_penjualan_id == '' && $no_faktur != '' && $status == 0 && $penjualan_type_id != 3 ) {?>
	                            <a style='float:right' href="#portlet-config-PO" data-toggle="modal" class="btn btn-lg btn-default ">CREATE PO</a>
							<?}?>
...
<?include_once "penjualan_detail_script_new.php";?>