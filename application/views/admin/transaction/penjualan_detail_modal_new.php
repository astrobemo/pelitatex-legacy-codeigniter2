<iframe id="print-pdf-dynamic"  src="" hidden ></iframe>
						...
						<form action="<?=base_url('transaction/penjualan_list_insert')?>" class="form-horizontal" id="form_add_data" method="post">
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-md-6">
									...
									<input id="inputPOAdd" name='po_number' maxlength='30' class='form-control' placeholder="po manual">
			                    </div>
			                </div> 
					...
					<div class="modal-body">
						<table>
							<tr>
								...
								<td class='text-right'>
									<div id='stok-info' style='border:1px solid #ddd; margin-bottom:20px;'>
										<table>
											<tr>
												<?$bg = ($po_penjualan_id != '' ? 'background:lightpink' : 'background:#ddd')?>
												<td style="<?=$bg;?>; padding:5px 10px;">
													PO : <span class='po-qty'><?=($po_penjualan_id != '' ? '0' : '-');?></span><br/>
												</td>
							...
							<?}else{?>
								<div class="form-group">
									...
									* </span>
									...
									<div class="col-md-6">
										<input type="text" name="barang_id" id='inputBarangPOEdit' hidden>
										<input type="text" name="warna_id" id='inputWarnaPOEdit' hidden>
						...
						<div style='height:400px;overflow:auto'>
							<table>
								<tr>
									...
									<td>
										<td class='text-right'>
											<div id='stok-info-edit' style='border:1px solid #ddd;margin-bottom:20px;'>
		...
		<div class="modal fade" style="position:relative" id="portlet-config-PO" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						<form action="<?=base_url('transaction/po_penjualan_insert')?>" class="form-horizontal" id="form_po_add_data" method="post">
							...
							<div class="form-group customer_section">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-6">
	                    			<input name='penjualan_id' hidden value="<?=$penjualan_id?>">
	                    			<input name='customer_id' hidden value="<?=$customer_id?>">
	                    			<input disabled class='form-control' value="<?=$nama_customer;?>">
			                    </div>
			                </div>
							...
							<div class="form-group">
			                    ...
			                    <div class="col-md-6">
	                    			<input autocomplete="off" name='po_number' maxlength='100' id="po_number_add" class='form-control' value="<?=$po_number?>">
			                    </div>
			                </div> 
							...
							<div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-6">
	                    			<input autocomplete="off" name='tanggal' class='form-control date-picker' id="tanggal_po_add" value="<?=$tanggal?>"  >
			                    </div>
			                </div>
					...
					<div class="modal-footer">
						<!-- <button type="button" class="btn blue btn-active btn-save-tab" title='Save & Buka di Tab Baru'>Save & New Tab</button> -->
						<button type="button" class="btn blue btn-active btn-trigger" id="btnAddPOPenjualan" onclick="submitFormPO()" >Save</button>
						<button type="button" class="btn btn-active default" data-dismiss="modal">Close</button>
					</div>
				</div>
				<!-- /.modal-content -->
