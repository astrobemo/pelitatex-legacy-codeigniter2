...
<?=link_tag('http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all'); ?>
...
<!-- BEGIN THEME STYLES -->
<link rel="stylesheet" type="text/css" href="<?=base_url('assets/global/css/components.css'); ?>" id="style_components" rel="stylesheet" type="text/css"/>
