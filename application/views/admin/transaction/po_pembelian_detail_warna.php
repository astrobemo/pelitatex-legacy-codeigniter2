					...
					<div class="portlet-body">
									...
									<table>
								    	<?foreach ($po_pembelian_data_detail as $row) {?>
									    	...
									    	<tr>
									    		...
									    		<td class='padding-rl-5'> : </td>
									    		<td class='td-isi-bold'>
									    			<?=number_format($qty_warna_total,'0',',','.');?>
									    		</td>
									    	</tr>
									    	...
									    	<tr>
									    		...
									    		<td class='padding-rl-5'> : </td>
									    		<td class='td-isi-bold'>
									    			<?=number_format($qty_datang_total,'0',',','.');?>
									    		</td>
									    	</tr>
								    	<?}?>
								    </table>
						...
						<hr/>
							<?
								...
								$qty_warna_blm_datang = $qty_warna_total - $qty_datang_total;
								...
								$persen_order_bar = $persen_order_width;
									$total_hidden = '';
								if ($persen_datang_width + $persen_order_width > 100) {
									$persen_order_bar = 100 - $persen_datang_width;
							...
							<div style='background:#999; height:50px; border-radius:5px;font-size:0'>
								...
								<div class='percent-bar' style="width:<?=$persen_order_bar;?>%;background:#45B6AF"><span><?=number_format($qty_warna_blm_datang,'0',',','.');?><br/><small>(<?=$persen_order_width;?>%)</small> </span></div>
								<div class='percent-bar' style="width:<?=$persen_total;?>%; <?=$total_hidden;?>"><span><?=number_format($qty_order - $qty_warna_total,'0',',','.');?><br><small>(<?=$persen_total?>%)</small> </span></div>
							</div>
							<div>
								Keterangan : 
								<ul>
									...
									<li><span style='width:25px; height:10px;background:#999; display:inline-block'></span> <b>Belum Turun PO Warna</b></li>
								</ul>
							</div>
						<hr/>

						<!-- table-striped table-bordered  -->
						<div class='col-xs-12' id='general_table'>
							...
							<?foreach ($po_pembelian_data_warna as $row) {
								...
								?>
								<div class='col-xs-4 bubble-container warna'>
									<table>
										<tr>
											<td>
												<div class='<?=$class?>'>
											...
											<td style='vertical-align:top; padding:20px 0 0 20px'>
												<div class='text-left'>
													Warna : <b><?=$row->nama_warna;?></b> <br>
													Batch Order : <b><?=$row->batch?></b> <br/>
													Tgl : <b><?=is_reverse_date($row->tanggal);?></b><br/>
													Order/Datang : <b><?=number_format($row->qty_warna,'0',',','.');?></b>/<b><?=number_format($qty_total_datang,'0',',','.');?></b><br/>
													<!-- OCKH : <input name='OCKH' class='input-ockh' value='<?=$row->OCKH;?>'> -->
