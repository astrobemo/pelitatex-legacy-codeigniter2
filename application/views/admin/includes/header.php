...
<head>
<meta charset="utf-8"/>
<title><?=$breadcrumb_title?> - GRACETDJ v.2.8.0.0</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta content="width=device-width, initial-scale=1" name="viewport"/>
<meta content="" name="description"/>
<meta content="" name="author"/>
<link rel="icon" href="<?=base_url();?>image/icon.png" type="image/x-icon">
<style type="text/css">
	...
	<div class='page-header-top'>
		<div class="container">
			<div class="page-logo" style='width:355px'>
				<a href="<?=base_url();?>admin"><h1 style='color:#F44336'>GRACETDJ <b style='font-size:0.5em; color:lightblue'>v.2.8.0.0</b></h1></a>
			</div>
			...
			<div class='top-menu'>
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						...
						<img alt="" class="img-circle" style='top:5px;position:relative;height:30px' src="<?=base_url('assets/admin/layout/img/avatar.png'); ?>"/>
