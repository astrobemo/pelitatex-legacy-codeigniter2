...
<head>
<meta charset="utf-8"/>
<title>BLESSINGTDJ v.2.8.0.0 - Sistem</title>
...
<?php include("stylesheet_blessing.php"); ?>
	...
	<div class='page-header-top'>
		<div class="container">
			<div class="page-logo" style='width:355px'>
				<a href="<?=base_url();?>admin"><h1 style='color:#F44336'>BLESSINGTDJ <b style='font-size:0.5em; color:lightblue'>v.2.8.0.0</b></h1></a>
			</div>
