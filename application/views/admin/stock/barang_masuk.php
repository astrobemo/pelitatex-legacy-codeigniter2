			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						<form action="<?=$common_data['controller_main'].'/barang_masuk_insert';?>" class="form-horizontal" id="form_add" method="post" target="_blank">
							<h3 class='block'> Pembelian </h3>
			                ...
			                <div class="form-group">
			                    <label class="control-label col-md-3">Surat Jalan<span class="required">
			                    * </span>
			                    </label>
			                    <div class="col-md-6">
	                    			<input name="surat_jalan" class='form-control' value=""/>
			                    </div>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-6">
	                    			<select class='form-control' name='pembelian_id' id='invoice_select'>
	                    				<option value="">Pilih Invoice</option>
	                    				<?foreach ($pembelian_list as $row) { ?>
	                    					<option value="<?=$row->id.'??'.$row->po_type;?>"><?=$row->invoice_number.' - '.$row->nama_supplier;?></option>
	                    				<? } ?>
	                    			</select>
			                    </div>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-6">
	                    			<select readonly class='form-control' name='po_type'>
	                    				<option>...</option>
...
jQuery(document).ready(function() {
	...
	$("#general_table").DataTable({
   		"fnCreatedRow": function( nRow, aData, iDataIndex ) {
   			var data = $('td:eq(5)', nRow).text().split('??');
   			var barang_masuk_id = data[0];
   			var po_type = data[1];
			var action = '<a href="stock/barang_masuk_detail_view?barang_masuk_id='+data[0]+'&po_type='+po_type+'" class="btn btn-xs yellow-gold" onclick="window.open(this.href, \'newwindow\', \'width=1250, height=650\'); return false;"><i class="fa fa-search"></i></a>';
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": baseurl + "stock/barang_masuk_data"
	});
