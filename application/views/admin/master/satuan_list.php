    ...
    <div class='container'>
            ...
            <div class="col-md-12">
                <div class="portlet light">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#">Satuan</a></li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('master/satuan_list_insert') ?>" autocomplete='off' class="form-horizontal" id="form_add_data" method="post" onkeydown="return event.key != 'Enter';">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control input1" id="nama" name="nama" />
        ...
        <div class="modal fade" id="portlet-config-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <form action="<?= base_url('master/satuan_list_update') ?>" autocomplete='off' class="form-horizontal" id="form_edit_data" method="post" onkeydown="return event.key != 'Enter';">
...
jQuery(document).ready(function() {
    ...
    $('.btn-save').click(function() {
        ...
        $.ajax({
            url: "<?= base_url('master/satuan_validate_start/new/0') ?>",
            type: "POST",
    ...
    $('.btn-edit-save').click(function() {
        //get id
        var id = $('#form_edit_data [name=id]').val();
        ...
        $.ajax({
            url: "<?= base_url('master/satuan_validate_start/edit/'); ?> " + '/' + id,
            type: "POST",
    ...
    $('#general_table').on('click', '.btn-activate', function() {
        var data = status_aktif_get($(this).closest('tr')) + '=?=satuan';
        ...
        bootbox.confirm("Yakin untuk " + text + " satuan <b>" + nama + "</b> ?", function(respond) {
            if (respond) {
                window.location.replace(baseurl + "master/ubah_status_aktif?data_sent=" + data + '&link=satuan_list');
            };
        });
    });
});
