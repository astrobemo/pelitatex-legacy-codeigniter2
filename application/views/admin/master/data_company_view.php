						...
						foreach ($data_company as $row) {
							...
							<div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control input1" name="nama" value="<?=$nama;?>" />
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control" name="alamat" value="<?=$alamat;?>"/>
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control" name="kelurahan" value="<?=$kelurahan;?>"/>
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control" name="kecamatan" value="<?=$kecamatan;?>"/>
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control" name="provinsi" value="<?=$provinsi;?>"/>
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control" name="kode_pos" value="<?=$kode_pos;?>"/>
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    * </span>
			                    ...
			                    <div class="col-md-7">
			                    	<input readonly type="text" class="form-control" name="telepon" value="<?=$telepon;?>"/>
			                    </div>
