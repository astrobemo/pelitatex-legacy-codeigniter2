                        ...
                        <div class="tabbable tabs-left">
                            <ul class="nav nav-tabs ">
                                ...
                                foreach ($daftar_harga_all as $row) {
                                    ...
                                    <li class="<?=$selected;?> <?=$row->tipe == 1 ? "tab-cash-title" : "tab-kredit-title"?>" >
                                ...
                                <table class="" id="general-table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($harga_jual_berlaku as $row) {
                                            $is_master[$row->barang_id] = ($row->tipe == 'harga_master' ? true : false);
                                            if ($tipe == 1) {
                                                $harga_cash_berlaku[$row->barang_id] = $row->harga_berlaku;
                                                if($is_master[$row->barang_id]){
                                                    $hcb[$row->barang_id] = str_replace(",00","", number_format($row->harga_berlaku,"2",",",'.'));
                                                }
                                            }else{
                                                $harga_kredit_berlaku[$row->barang_id] = $row->harga_berlaku;
                                                if($is_master[$row->barang_id]){
                                                    $hkb[$row->barang_id] = str_replace(",00","", number_format($row->harga_berlaku,"2",",",'.'));
                                                }
                                            }
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <?if ($tipe == 1) {?>
                                                <th id="cashUp"></th>
                                                <!-- <th>(%)</th> -->
                                                <th colspan='2' id="cashUpRate"></th>
                                            <?}?>
                                            <?if ($tipe == 2) {?>
                                                <th id="kreditUp"></th>
                                                <!-- <th>(%)</th> -->
                                                <th colspan='2' id="kreditUpRate"></th>
                                            <?}?>
                                        </tr>
                                        <tr>
                                            <th>Harga Turun</th>
                                            <?if ($tipe == 1) {?>
                                                <th id="cashDown"></th>
                                                <!-- <th>(%)</th> -->
                                                <th colspan='2' id="cashDownRate"></th>
                                            <?}?>
                                            <?if ($tipe == 2) {?>
                                                <th id="kreditDown"'></th>
                                                <!-- <th>(%)</th> -->
                                                <th colspan='2' id="kreditDownRate"></th>
                                            <?}?>
...
function updateRekap(){
    ...
    <?if ($tipe==1) {?>
        ...
        document.querySelector("#cashUp").innerHTML =  cashUp + ' item' ;
        document.querySelector("#cashUpRate").innerHTML =  res_perc_cash_up.toFixed(2) + '%' ;
        document.querySelector("#cashDown").innerHTML = cashDown + ' item';
