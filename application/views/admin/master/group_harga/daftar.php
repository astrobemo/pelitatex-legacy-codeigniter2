                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('masters/group_harga/daftar') ?>" autocomplete='off' class="form-horizontal" id="form_add_data" method="post" onkeydown="return event.key != 'Enter';">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div>
                                        <label class='radio-inline'><input type="radio" id='tipeCash' <?=(set_value('tipe') == 1 ? 'checked' : '' );?> name='tipe' value='1'>CASH</label>
                                        <label class='radio-inline'><input type="radio" id='tipeKredit'  <?=(set_value('tipe') == 2 ? 'checked' : '' );?> name='tipe' value='2'>KREDIT</label>
                                    </div>
                                </div>
                            </div>
