                  ...
                  <div class="col-md-12">
                        <div class="portlet light">
                              ...
                              <ul class="nav nav-pills">
                                    <li><a href="<?= base_url(is_setting_link('masters/documentcontrol/daftar')); ?>">Document Control</a></li>
                                    <li class="active"><a href="<?= base_url(is_setting_link('masters/department/daftar')); ?>">Department</a></li>
                              </ul>
