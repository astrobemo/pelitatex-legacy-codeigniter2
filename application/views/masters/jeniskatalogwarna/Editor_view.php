            ...
            <form action="#" class="form-horizontal" id="frmAdd" name="frmAdd" method="post" autocomplete="off">
                  <div class="modal-content">
                        <div class="modal-header">
                              <h3><span id="flgData" name="flgData"></span> <b>Jenis Katalog Warna</b></h3>
                        ...
                        <div class="modal-body">
                              <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                          <input type="text" id="txtKode" name="txtKode" class="form-control" />
                                          <span id="errKode" name="errKode" class="help-block" style="color: red"></span>
                                    </div>
                              </div>
...
<script>
      ...
      $(document).ready(function() {
            let form = "#frmAdd";
            let controls = ['txtKode', 'txtNama'];
            let errControls = ['errKode', 'errNama'];
                        ...
                        $.ajax({
                              ...
                              success: function(data) {
                                    ...
                                    if (result == false) {
                                          ...
                                          if (typeof(data['data']['kode']) != 'undefined')
                                                $(form + ' #' + errControls[0]).text(data['data']['kode']);
