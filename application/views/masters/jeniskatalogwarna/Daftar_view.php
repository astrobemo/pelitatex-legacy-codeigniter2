                  ...
                  <div class="col-md-12">
                        <div class="portlet light">
                              ...
                              <ul class="nav nav-pills">
                                    ...
                                    <li class="active"><a href="<?= base_url(is_setting_link('masters/jeniskatalogwarna/daftar')); ?>">Jenis Katalog Warna</a></li>
                              </ul>
...
<script>
      var address_root = '<?= get_api_base_link(); ?>' + 'katalog_warna_jenis/';
                  ...
                  "columnDefs": [{
                        ...
                        },
                        {
                              ...
                              "render": function(data, type, row, meta) {
                                    let hasil = JSON.stringify([row['id'], row['kode'], row['nama'], row['status_aktif']]);
