                  ...
                  <div class="col-md-12">
                        <div class="portlet light">
                              ...
                              <ul class="nav nav-tabs">
                                    <li><a href="<?= base_url(is_setting_link('masters/satuan/daftar')); ?>">Group Barang</a></li>
                                    <li class="active"><a href="<?= base_url(is_setting_link('masters/katalogwarna/daftar')); ?>">Katalog Warna</a></li>
                              </ul>

                              <!-- tab -->
                              <ul class="nav nav-pills">
                                    <li class="active"><a href="<?= base_url(is_setting_link('masters/katalogwarna/daftar')); ?>">Katalog Warna</a></li>
                                    <li><a href="<?= base_url(is_setting_link('masters/jeniskatalogwarna/daftar')); ?>">Jenis Katalog Warna</a></li>
                              </ul>
                  ...
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                          <select id='cboJenisFilter' name='cboJenisFilter' style="width: 100%" class="form-control">
                                                <?php
...
<script>
      ...
      $(document).ready(function() {
            // registrasi select2
            $("#cboJenis, #cboJenisFilter").select2();
            ...
            table = $('#table').DataTable({
                  "pageLength": 25,
                  "ajax": {
                        'url': address_root + 'list/1/' + jenis_id,
                        'type': 'get',
                        'dataType': 'JSON',
                        'data': {
                              'token': token
                  ...
                  "columnDefs": [{
                        ...
                        },
                        {
                              ...
                              "render": function(data, type, row, meta) {
                                    let hasil = JSON.stringify([row['id'], row['kode'], row['nama'], row['kode_warna'], row['status_aktif'], row['jenis_id']]);
            ...
            $('#btnStart').click(function() {
                  ...
                  jenis_id = $("#cboJenisFilter").val();

                  table.ajax.url(address_root + 'list/' + status_aktif + '/' + jenis_id).load();
