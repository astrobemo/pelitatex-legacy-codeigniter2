                  ...
                  <div class="col-md-12">
                        <div class="portlet light">
                              ...
                              <ul class="nav nav-pills">
                                    <li class="active"><a href="<?= base_url(is_setting_link('masters/satuan/daftar')); ?>">Satuan</a></li>
                                    <li><a href="<?= base_url(is_setting_link('masters/kategoribarang/daftar')); ?>">Kategori Barang</a></li>
                                    <li><a href="<?= base_url(is_setting_link('masters/tipebarang/daftar')); ?>">Tipe Barang</a></li>
...
<script>
      var address_root = '<?= get_api_base_link(); ?>' + 'satuan_barang/';
