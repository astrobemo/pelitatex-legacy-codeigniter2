...
//=====================================================Stok inventory======================================
	...
	function get_stok_for_pre_po($barang_id_pool, $tanggal_akhir, $tanggal_awal, $stok_opname_id, $cond_barang, $tahun_tutup_buku, $bulan_qty){
					...
					(
						...
						FROM(
							(
								...
								SELECT barang_id, warna_id, t1.gudang_id, 0, 0, subqty, subjumlah_roll, created_at as tanggal, 3, t1.id
								FROM nd_penjualan_detail t1
								LEFT JOIN (
									SELECT *
									FROM nd_penjualan
...
//=====================================================Stok + HPP======================================
	...
	function get_harga_hpp($kolom_harga, $kolom_qty, $tanggal_start, $tahun, $tanggal_akhir){
		$query = $this->db->query("SELECT barang_id, warna_id, ROUND(sum(total)/sum(qty),3) as hpp, sum(total), sum(qty), tipe, group_concat(harga)
				FROM ((
