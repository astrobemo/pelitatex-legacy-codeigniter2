...
class SKUBarang extends CI_Controller
{
      ...
      function daftar()
      {
            ...
            $data = array_merge($data, array(
                  ...
                  'breadcrumb_small' => 'SKU Barang',
                  'content' => 'masters/skubarang/daftar_view',
                  'editor' => 'masters/skubarang/editor_view',
                  'skucentral' => 'masters/skubarang/skucentral_view',
            ));
