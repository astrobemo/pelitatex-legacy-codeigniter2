...
//======================================stok barang all+ PO============================================
	...
	function stok_barang_and_po(){
        ...
        if ($barang_id != '') {
			...
			$data['barang_list_selected'] = $this->inv_model->get_stok_for_pre_po('', $tanggal.' 23:59:59' /*as tanggal_akhir*/, $tanggal_awal, $stok_opname_id, $cond_barang, $tahun_tutup_buku, $bulan_qty);
