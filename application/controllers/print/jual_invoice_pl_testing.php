<?php
class Jual_Invoice_Pl_Testing extends CI_Controller
{
      ...
      function print_header($pdf, $judul, $profile, $header)
      {
            ...
            if (is_posisi_id() != 1) {
                  ...
                  $pdf->Line('4',$pdf->getY(), 204, $pdf->getY());
                  $pdf->Cell($x_po, 6, $no_po, '', 0, 'L', 0);
                  $pdf->Cell($x_sj, 6, ($is_pengiriman ? $no_sj : ''), '', 0, 'L');
                  $pdf->Cell($x_batas, 6, '', '', 0, 'L');
                  $pdf->Cell($x_invoice_flag, 6, 'INVOICE :  ', '', 0, 'R');
                  $pdf->Cell($x_invoice, 6, $no_invoice, '', 1, 'R');
