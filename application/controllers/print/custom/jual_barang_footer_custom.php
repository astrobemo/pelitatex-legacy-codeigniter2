<?php
                  ...
                  for ($i = 0; $i <= count($bayar); $i++) {
                        ...
                        if ($i <= count($unit) - 1) {
                              if ($i == 0) {
                                    ...
                                    $pdf->Cell($this->col_barang['space'] + $this->col_barang['kode_beli'] + $this->col_barang['barang'], $x_height, '', 0, 0, 'B'); //space barang
            ...
            //keterangan tambahan
            if (isset($header['keterangan']) && $header['keterangan'] != '') {
                  $pdf->SetFont('Calibri', '', 10);
                  $pdf->Text(5,$yKet,"KET: ".$header['keterangan']);
            }
