...
//===================================po pembelian=============================================
    ...
    function po_pembelian_batch_insert()
    {
        ...
        $data = array(
            ...
            'tanggal' => is_date_formatter($this->input->post('tanggal')),
            'batch' => $batch,
            'keterangan_batch' => $this->input->post('keterangan_batch')
        );
    ...
    function update_keterangan_batch(){
        ...
        $result = $this->common_model->db_update('nd_po_pembelian_batch', $data,'id',$batch_id);
        echo "OK";
...
//===================================pembelian=============================================
    ...
    function get_ockh(){
        ...
        if (is_posisi_id()==1) {
            // echo '--'.$po_pembelian_batch_id.' '.$barang_id.' '. $warna_id.' '. $tipe_barang.'--';
        }
        echo $ockh;
    }
